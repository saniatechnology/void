...
export default function PostCreator({ setShowPostCreator, username }) {
  ...
  return (
    <div className="w-[100vw] h-[100vh] fixed pt-[8rem] flex flex-col bg-[#CACACA] border-b border-red">
      ...
      <div className="flex divide-x divide-[#E9E7E7] w-full h-[70px] fixed bottom-0 text-[#6E6E6E] border-t border-[#E9E7E7]">
        <div className={`flex-1 flex items-center justify-end pr-28 ${isHovered === "close" ? "text-[#6E6E6E] bg-[#ff7563]" : ""}`}>
        ...
        <div className={`flex-1 flex items-center pl-28 ${isHovered === "check" ? "text-[#6E6E6E] bg-[#FFEA63]" : ""}`}>
          <button onClick={() => setShowPostCreator(false)} onMouseEnter={() => setIsHovered("check")} onMouseLeave={() => setIsHovered(null)} className="hover:text-gray-500/80">
