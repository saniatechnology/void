...
export default function PostContainer({ post }) {
  ...
  return (
    <div className={`w-full flex flex-col gap-3 py-5 border-b-2 border-gray-400/60 cursor-default ${isDeleted && "line-through pointer-events-none"}`}>
      ...
      <form onSubmit={handleSubmit}>
        <textarea ref={textareaRef} rows="1" value={content} onChange={handleChange} wrap="soft" className={`w-full p-5 bg-white/20 border-none focus:outline-none resize-none ${isDeleted && "line-through"}`}></textarea>
      </form>
